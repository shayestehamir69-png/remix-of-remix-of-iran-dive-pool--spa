          ...
          <div>
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="w-10 h-10 rounded-full bg-blue-500/10 border border-blue-500/30 flex items-center justify-center text-blue-400 hover:bg-blue-500/20 hover:text-blue-300 transition-all hover:scale-110"
          ...
          <div>
            ...
            <ul className="space-y-3 mb-6">
              ...
              <li>
                ...
                >
                  ...
                  <span className="text-sm" dir="ltr">+98 21 2221 0973</span>
                </a>
              </li>
              <li>
                <a 
                ...
                >
                  ...
                  <span className="text-sm" dir="ltr">info@irandive.ir</span>
                </a>
              </li>
            </ul>
            ...
            <ul className="space-y-3">
              <li>
                ...
                >
                  <div className="w-5 h-5 flex items-center justify-center">
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-green-400 group-hover:text-green-300">
              ...
              <li>
                ...
                >
                  <div className="w-5 h-5 flex items-center justify-center">
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-blue-400 group-hover:text-blue-300">
