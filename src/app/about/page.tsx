            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                {language === 'en'
                  ...
                  : 'در سال ۱۳۵۲، محمدرضا باقری شایسته شرکت ایران دایو را با روحیه‌ای آینده‌نگر و اشتیاق عمیق به هنر و مهندسی آب تأسیس کرد. از همان ابتدا، ایران دایو با مأموریتی روشن آغاز به کار کرد: طراحی و ساخت فضاهایی که در آن آب، آرامش و زیبایی در هماهنگی کامل در کنار هم قرار دارند. در طول پنج دهه گذشته، این شرکت به یکی از نام‌های پیشرو در صنعت ساخت‌وساز آبی ایران تبدیل شده است - با تخصص در طراحی و ساخت استخرهای شنا، سونا، جکوزی، پارک‌های آبی و سازه‌های آبی مدرن. مهندسی دقیق، نوآوری مستمر و الهام‌گیری از زیبایی طبیعت، ارزش‌های اصلی هستند که در هر پروژه ایران دایو جاری است - از استخرهای خصوصی لوکس تا مجتمع‌های تفریحی و ورزشی در مقیاس بزرگ.'}
              </p>
              <p className="text-gray-300 leading-relaxed mb-4">
                {language === 'en'
