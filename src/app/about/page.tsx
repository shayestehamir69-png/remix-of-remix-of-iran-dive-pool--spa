        ...
        <div className="relative container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-32">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="text-gray-300 leading-relaxed mb-4">
                {language === 'en'
                  ? 'In 1973, Mohammadreza Bagheri Shayesteh founded Iran Dive Company with a visionary spirit and a deep passion for the art and engineering of water. From the very beginning, Iran Dive set out with a clear mission: to design and build spaces where water, tranquility, and elegance coexisted in perfect harmony. Over the decades, the company became a leading name in Iran\'s aquatic construction industry — specializing in the design and construction of swimming pools, saunas, jacuzzis, water parks, and modern aquatic structures. Precision engineering, continuous innovation, and inspiration drawn from the beauty of nature were the core values that flowed through every Iran Dive project — from luxurious private pools to large-scale recreational and sports complexes.'
                  : 'در سال ۱۳۵۲، محمدرضا باقری شایسته شرکت ایران دایو را با روحیه‌ای آینده‌نگر و اشتیاق عمیق به هنر و مهندسی آب تأسیس کرد. از همان ابتدا، ایران دایو با مأموریتی روشن آغاز به کار کرد: طراحی و ساخت فضاهایی که در آن آب، آرامش و زیبایی در هماهنگی کامل در کنار هم قرار دارند. در طول پنج دهه گذشته، این شرکت به یکی از نام‌های پیشرو در صنعت ساخت‌وساز آبی ایران تبدیل شد - با تخصص در طراحی و ساخت استخرهای شنا، سونا، جکوزی، پارک‌های آبی و سازه‌های آبی مدرن. مهندسی دقیق، نوآوری مستمر و الهام‌گیری از زیبایی طبیعت، ارزش‌های اصلی بودند که در هر پروژه ایران دایو جاری بود - از استخرهای خصوصی لوکس تا مجتمع‌های تفریحی و ورزشی در مقیاس بزرگ.'}
              </p>
              <p className="text-gray-300 leading-relaxed mb-4">
                {language === 'en'
                  ? 'His commitment to innovation and quality set new standards in the industry. Under his leadership, IRAN DIVE completed hundreds of prestigious projects, earning the trust of clients across the country.'
                  : 'تعهد او به نوآوری و کیفیت، استانداردهای جدیدی را در صنعت تعیین کرد. تحت رهبری او، ایران دایو صدها پروژه معتبر را به اتمام رساند و اعتماد مشتریان را در سراسر کشور به دست آورد.'}
              </p>
              <p className="text-gray-300 leading-relaxed">
                {language === 'en'
                  ? 'Beyond business, Mohammad Reza believed in creating spaces that enhanced people\'s quality of life and brought joy to families. His philosophy of "Excellence in Every Detail" continues to inspire IRAN DIVE today.'
                  : 'فراتر از کسب‌وکار، محمد رضا به ایجاد فضاهایی اعتقاد داشت که کیفیت زندگی مردم را ارتقا می‌داد و شادی را به خانواده‌ها می‌آورد. فلسفه او «برتری در هر جزئیات» امروزه همچنان ایران دایو را الهام می‌بخشد.'}
              </p>
            </div>
          </div>
        </div>
